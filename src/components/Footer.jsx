    ...
    return(
        <div id="footer">
            <div className="social-elements">
                <a href="https://github.com/Chuliann" target={"_blank"}>
                ...
                <a href="https://www.linkedin.com/in/julian-berton/" target={"_blank"}>
            ...
            <p>Diseñado y desarrollado por Julian Berton</p>
        </div>
    );
}
